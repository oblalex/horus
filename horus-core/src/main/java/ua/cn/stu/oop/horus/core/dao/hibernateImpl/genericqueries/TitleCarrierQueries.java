...
public class TitleCarrierQueries {
    ...
    private static final String GET_CARRIERS_BY_TITLE = "FROM %s WHERE title = ?";
    ...
    public static String getTitleCarriersByTitle(Class<? extends StringTitleCarrier> carrierClass) {
        return String.format(GET_CARRIERS_BY_TITLE, carrierClass.getName());
    }
}
